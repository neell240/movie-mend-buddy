...
export const BottomNav = () => {
  ...
  return (
    <nav 
      ...
      style={isChristmas ? {
        background: "linear-gradient(to right, hsl(140 25% 12%), hsl(145 28% 10%), hsl(140 25% 12%))",
        boxShadow: "0 -4px 20px hsl(140 25% 6% / 0.4)",
      } : undefined}
    >
            ...
            <Link
              ...
              className={cn(
                ...
                isChristmas
                  ? isActive 
                    ? "text-[hsl(355,72%,50%)]" 
                    : "text-[hsl(42,45%,80%)] hover:text-[hsl(42,85%,70%)]"
                  : isActive 
            ...
            >
              ...
              {isChristmas && isActive && (
                <motion.span 
                  ...
                  style={{
                    background: "linear-gradient(90deg, hsl(355 72% 50%), hsl(355 72% 42%), hsl(355 72% 50%))",
                    boxShadow: "0 0 12px hsl(355 72% 50% / 0.6), 0 0 24px hsl(355 72% 50% / 0.3)",
                  }}
